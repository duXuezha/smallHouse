...
git remote add origin(远程库名，可以自己起名字) git@github.com:GitHub用户名/learnGit.git //添加远程仓库   (码云：git remote add origin git@gitee.com:dy/learngit.git)
git remote  // 查看远程信息
...
https://git-scm.com/book/zh/v2  不错

git tag tagname(随便起)  // 建立标签
git tag  // 查看标签
git show tagname   // 查看某个标签的具体操作
git tag -d tagname  // 删除标签
git push origin tagname/--tags   // 把标签推送到远程服务(--tags 推送全部标签)
